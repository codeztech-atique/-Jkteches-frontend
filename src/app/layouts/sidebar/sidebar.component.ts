...
export class SidebarComponent implements AfterViewChecked {
	...
	constructor(private router: Router, private authenticationService: AuthenticationService, private commonService: CommonService, private http: HttpClient, private eRef: ElementRef) {
