...
export class RegisterPage implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.titleService.setTitle('Jkteches | Registration Page');
  ...
  // redirectToLinkedIn() {
  //   const clientId = '77mmjfsz45aw22';
  //   const redirectUri = encodeURIComponent('http://localhost:4200');
  //   // const redirectUri = encodeURIComponent('http://www.google.com');
  //   const scope = 'profile%20email';
  //   const state = '987654321'; // This should be a unique string for CSRF protection
